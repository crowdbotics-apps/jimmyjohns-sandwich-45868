"""
Django settings for jimmyjohns_sandwich_45868 project.
...
ROOT_URLCONF = 'jimmyjohns_sandwich_45868.urls'
...
WSGI_APPLICATION = 'jimmyjohns_sandwich_45868.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "jimmyjohns_sandwich_45868 API",
    "DESCRIPTION": "API documentation for jimmyjohns_sandwich_45868 App",
    "VERSION": "v1",
}
